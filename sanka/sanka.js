...
let tempsRestant=2**(nvDiff+1); délai(tempsRestant);
if (nvDiff>5){document.getElementById("pub").style.display="block";
document.getElementById("pub").innerHTML=`Il faut être au moins niveau ${nvDArt-5} pour accéder à cet article. Vous êtes à niveau ${localStorage.getItem("nvTilapya")}`;
}
}