...
const choix=['Pierre', 'Papier', 'Ciseaux']; const choixJP=['いし', 'かみ', 'はさみ']; let joueur;　let ordi;　let score=[0,0];

const handleClick = (e) => {joueur = e.target.id; ordiDas(); scoreDas()}
const ordiDas = () => {const alea = choix[Math.floor(Math.random() * choix.length)];ordi=alea;}
...
scoreDas=()=>{let jIndex=choix.indexOf(joueur); let vict=0;
